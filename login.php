            ...
            <div id="login-container">
                <form action='login.php' method='post'>
                    <fieldset name="type">
                        ...
                        <input type='email' name='user' id="login-email">
                        <label for="password">Password:</label>
                        <input type='password' name='password' id='login-password'>
                        <!-- <input type='submit' name='login' value="Login" id="loginBtn" onclick="return checkFilledFunction('login');"> -->
                        <input type='submit' name='login' value="Login" id="loginBtn" onclick="return getUser();">
            ...
            <div id="register-container" class="hidden">
                <form action='login.php' method='post'>
                    <fieldset name="type">
                        ...
                        <input type='submit' name='register' value="Register" id="registerBtn" onclick="return createUser();">
...
function authenticate() {
    ...
    if (isset($_POST['user']) && isset($_POST['password']) && isset($_POST['usertype'])) {
        ...
        $url = 'https://dml-layer2-backend.onrender.com/api/getUser/'.$email.'/'.$password.'/'.$type;
