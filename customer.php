...
function display_customer_page() {
  ...
  <body>
    ...
    <div id="login-container">
        <div>
        <p id="login-title">Logged into Customer account:<p id="useremail"><?php echo $_SESSION['user']?></p></p>
        </div>
        ...
        <!-- <h3>That's it!</h3>
        <h3>We will send you an email shortly containing links to download your updated model and weights.</h3> -->
        <h3 id="upload-finished"></h3>
